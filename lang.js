const translations = {
  fr: {
    ...
    'produits.intro': 'Basic, Medium ou Maxi — chaque station est gratuite à l\'installation, personnalisable, et maintenue par BOD.',
    ...
    'produits.basic.f4': 'Personnalisation wrap vinyl incluse',
    ...
    'produits.medium.f4': 'Personnalisation wrap vinyl incluse',
    ...
    'produits.maxi.f4': 'Personnalisation wrap vinyl incluse',
    ...
    'produits.wrap.p': 'Chaque station est habillée d\'un wrap vinyl aux couleurs et à l\'identité de votre établissement. Logo, ambiance, code couleur — la station devient une extension naturelle de votre décor.',
    ...
    'produits.wrap.f3.title': 'Inclus dans l\'offre',
    'produits.wrap.f3.text': 'La personnalisation ne coûte rien de plus. Elle fait partie de l\'installation.',
    'produits.wrap.visual.title': 'Votre station,<br/>vos couleurs.',
    'produits.wrap.visual.sub': 'L\'écran reste celui de BOD.',
    'produits.wrap.visual.note': 'Toutes les couleurs disponibles',
    ...
    'produits.final.p': 'Installation gratuite, personnalisation incluse, zéro engagement.',
  ...
  en: {
    ...
    'produits.intro': 'Basic, Medium or Maxi — every station is free to install, customisable, and maintained by BOD.',
    ...
    'produits.basic.f4': 'Vinyl wrap customisation included',
    ...
    'produits.medium.f4': 'Vinyl wrap customisation included',
    ...
    'produits.maxi.f4': 'Vinyl wrap customisation included',
    ...
    'produits.wrap.p': 'Every station is wrapped in vinyl matching your venue\'s identity. Logo, colours, ambiance — the station becomes a natural extension of your decor.',
    ...
    'produits.wrap.f3.title': 'Included in the offer',
    'produits.wrap.f3.text': 'Customisation costs nothing extra. It\'s part of the installation.',
    'produits.wrap.visual.title': 'Your station,<br/>your colours.',
    'produits.wrap.visual.sub': 'The screen stays BOD.',
    'produits.wrap.visual.note': 'All colours available',
    ...
    'produits.final.p': 'Free installation, customisation included, no commitment.',
